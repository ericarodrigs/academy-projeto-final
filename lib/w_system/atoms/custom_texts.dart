...
class WTextFormFIeld extends StatelessWidget {
   const WTextFormFIeld({required this.text, this.validator ,Key? key}) : super(key: key);
  final String text;
...
class WTextButton extends StatelessWidget {
   const WTextButton({required this.text,this.style,this.onTap,Key? key}) : super(key: key);
  final String text;
  final TextStyle? style;
  final Function()? onTap;
  @override
  Widget build(BuildContext context) {
    return InkWell(onTap:onTap, child: Ink(child: Text(text,style: style,)));
  }
}
