...
void main() {
  ...
  VideoModel video1 = VideoModel(id: '1', name: 'testvideo1', url: 'url', thumbUrl: 'url', description: 'description', createdAt: 'creator1', duration: '1:20', publicationDate: '01/01/2022', topic: 'tests', tags: ['tag']);
  VideoModel video2 = VideoModel(id: '2', name: 'testvideo2', url: 'url', thumbUrl: 'url', description: 'description', createdAt: 'creator2', duration: '2:20', publicationDate: '02/02/2022', topic: 'tests', tags: ['tag']);
  VideoModel video3 = VideoModel(id: '3', name: 'testvideo3', url: 'url', thumbUrl: 'url', description: 'description', createdAt: 'creator3', duration: '3:20', publicationDate: '03/03/2022', topic: 'tests', tags: ['tag']);
